...
class Trainer(object):
    def __init__(self, args):
        ...
        try:
            ...
            eval_image_path = 'D:/ICPR/possible_methods/ICPR-Track2-LightWeight-main/result_WS/' + args.st_model + '/' + 'visulization_result'
            eval_fuse_path = 'D:/ICPR/possible_methods/ICPR-Track2-LightWeight-main/result_WS/' + args.st_model + '/' + 'visulization_fuse'
