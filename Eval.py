...
Pd = 0.75  # 检测率 Detection rate
IoU = 0.50  # 平均交并比 average intersection over union
Params = 0.166825  # 模型参数量 M Parameters of your model (Unit: M)
Flops = 1.296862  # 模型运算量 GFlops of your model
