...
class LightWeightNetwork(nn.Module):
    def __init__(self, n_classes=1, encoder_relu=False, decoder_relu=True, channel=(8, 32, 64), dilations=(2, 4, 8, 16),
                 kernel_size=(3, 5, 7, 9), padding=(1, 2, 3, 4)):
        super().__init__()
...
#     model = LightWeightNetwork(channel=(8, 32, 64), dilations=(2, 4, 8, 16), kernel_size=(7, 7, 7, 7),
#                              padding=(3, 3, 3, 3))  # kernel_size/padding = 5/2 7/3 9/4
#     # 可视化
...
#     print('FLOPs=', str(FLOPs / 1000000000.0) + '{}'.format('G'))
