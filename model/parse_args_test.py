...
def parse_args():
    ...
    parser.add_argument('--st_model', type=str, default='0_ICPR_Track2_UNet_09_07_2024_22_59_50_wDS')
    # parser.add_argument('--model_dir', type=str,
    #                     default = './result_WS/ICPR_Track2/model_weight.pth.tar')
    parser.add_argument('--model_dir', type=str,
                        default='D:/ICPR/possible_methods/ICPR-Track2-LightWeight-main/result_WS'
                                '/0_ICPR_Track2_UNet_09_07_2024_22_59_50_wDS/model_weight.pth.tar')
    # parser.add_argument('--model_dir', type=str,
    #                     default='D:/ICPR/possible_methods/ICPR-Track2-LightWeight-main/result_WS'
    #                             '/7_10_server_IDIPLAB/model_weight.pth.tar')
    parser.add_argument('--mode', type=str, default='TXT', help='mode name:  TXT, Ratio')
    parser.add_argument('--test_size', type=float, default='0.5', help='when --mode==Ratio')
    # parser.add_argument('--root', type=str, default='./dataset')
    parser.add_argument('--root', type=str, default='D:/ICPR/possible_methods/ICPR-Track2-LightWeight-main/dataset')
